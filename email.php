<?php
	...
	require 'logic/modules/PHPMailer/src/Exception.php';
	require 'logic/modules/PHPMailer/src/PHPMailer.php';
	require 'logic/modules/PHPMailer/src/SMTP.php';
				...
				<div class="col-12">
				  ...
				  <div data-aos="fade-right">
					...
					<div style="display: inline-block;">
						<form action="/email.php#distribution-form" method="post">
